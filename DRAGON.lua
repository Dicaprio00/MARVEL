...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Dicaprio00/MARVEL/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1911032583,1335307516,1914852231,1753323063,1610557559}   
...
os.execute('wget https://raw.githubusercontent.com/Dicaprio00/MARVEL/main/DRAGON.lua')
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Dicaprio00/MARVEL/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Dicaprio00/MARVEL/main/library')
os.execute('wget https://raw.githubusercontent.com/Dicaprio00/MARVEL/main/File_Bot')
send(msg.chat_id_, msg.id_,' ☆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
{
{text = '𝙼𝙰𝚁𝚃𝙴𝙽', url="t.me/I_C_X"},{text = '𝙼𝙾𝚂𝚃𝙰𝙵𝙰', url="t.me/M_P_L_6"},
},
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Dicaprio00/MARVEL/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Dicaprio00/MARVEL/main/File_Bot/"..file)
if res == 200 then
...
{
{text = ' اوامر التسليه ', callback_data="/help7"},{text = ' المميزات والالعاب',callback_data="/Dicaprio00"},
},
{
...
{
{text = ' اوامر التسليه ', callback_data="/help7"},{text = ' المميزات والالعا.',callback_data="/Dicaprio00"},
},
{
{text = ' اوامر القفل ', callback_data="/help1"},{text = ' اوامر التعطيل ', callback_data="/help2"},
},
...
{{text = 'القائمه الرائسيه', callback_data="/Dicaprio00"}},
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐦𝐚𝐫𝐯𝐞𝐥', url="t.me/G_K_00"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
